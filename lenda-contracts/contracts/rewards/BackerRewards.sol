...
import {LendaConfig} from "../protocol/core/LendaConfig.sol";
import {LendaConfigHelper} from "../protocol/core/LendaConfigHelper.sol";
...
/**
 * @title BackerRewards
 * @notice Handles rewards for backers who provide capital to tranched pools.
...
contract BackerRewards is IBackerRewards, BaseUpgradeablePausable, IEvents {
  ...
  function __initialize__(address owner, LendaConfig _config) public initializer {
    require(
  ...
  function _allocateRewards(uint256 _interestPaymentAmount) internal {
    ...
    totalInterestReceived = totalInterestReceived + _interestPaymentAmount;
  }
